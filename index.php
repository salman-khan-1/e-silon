...
?>
  ...
  <section class="banner__section">
    <div class="d__grid">
      <div class="banner__content w-50 container">
        <h5>ULTIMATE COLLECTION</h5>
  ...
  <section class="featured__product__section container">
    <h1>FEATURED PRODUCT</h1>

    <div class="img__container container">
      <div class="img__row row">
        <div class="col-md-4 col-sm-6">
          ...
          <div class="product__one">
            <h5>Red Woman Purses</h5>
            <div class="rating-css">
              <div class="star-icon">
                <input type="radio" name="rating1" id="rating1">
                <label for="rating1" class="far fa-star"></label>
                <input type="radio" name="rating2" id="rating2">
                <label for="rating2" class="far fa-star"></label>
                <input type="radio" name="rating3" id="rating3">
                <label for="rating3" class="far fa-star"></label>
                <input type="radio" name="rating4" id="rating4">
                <label for="rating4" class="far fa-star"></label>
  ...
  <section class="banner__section">
    <div class="background">
      <div class="second-banner__content w-50 container">
        <h1>50% OFF</h1>
  ...
  <section class="silon__journal__section">
    <h1>Silon Journal</h1>
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-sm-6">
          <div class="silon__journal__content">
            ...
            <div class="meta-tags">
              <a href="#" class="post-meta"><i class="fas fa-cube"></i>Women Fashion</a><a href="#" class="post-meta"><i
